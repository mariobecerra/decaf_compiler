...
Variable  :    Type T_Identifier    { $$ = new VarDecl(new Identifier(@2, $2),
                                           $1);
                                    }
;
